...
from .models import Staff,Student,NotificationStudent,FeedBackStaff,FeedBackStudent,NotificationStaff
...
from .forms import FeedbackStaffForm,FeedbackStudentForm,NotificationStaffForm,NotificationStudentForm
...
class Create_Student(CreateView):
    model = Student
    fields = ['id','name','lop','khoa','ngaysinh','quequan','email','address','gender','sdt']
    success_url = reverse_lazy('student')

class Create_Staff(CreateView):
    model = Staff
    fields = ['id','name','bomon','khoa_gd','ngaysinh','quequan','email','address','sdt']
